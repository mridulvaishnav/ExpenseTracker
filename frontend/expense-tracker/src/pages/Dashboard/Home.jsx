      ...
      <div className = "my-5 mx-auto">
        {/*<div className = "grid grid-cols-1 md:grid-cols-3 gap-6">
          <InfoCard
            icon = {<IoMdCard />}
            label = "Total Balance"
            value = {addThousandsSeparator(dashbaordData?.totalBalance || 0)}
            color = "bg-primary"
          />
          ...
          <InfoCard
            ...
            label = "Total Income"
            value = {addThousandsSeparator(dashbaordData?.totalIncome || 0)}
            color = "bg-orange-500"
          />
        ...
        <div className = "grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          ...
          <FinanceOverview
            ...
            totalExpense = {dashbaordData?.totalExpenses || 0}
          />
        </div>
      </div>
    </DashboardLayout>
